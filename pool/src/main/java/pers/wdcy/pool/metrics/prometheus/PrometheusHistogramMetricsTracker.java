...
import static pers.wdcy.pool.metrics.prometheus.PrometheusMetricsTrackerFactory.*;
import static pers.wdcy.pool.metrics.prometheus.PrometheusMetricsTrackerFactory.RegistrationStatus.REGISTERED;
